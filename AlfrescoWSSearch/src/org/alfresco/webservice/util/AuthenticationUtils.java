...
public class AuthenticationUtils implements CallbackHandler
{
    ...
    throws AuthenticationFault
    {
    	doStartSession(null, username, password);
    }

    public static void startSession(String endpointAddress, String username, String password)
    throws AuthenticationFault
    {
    	doStartSession(endpointAddress, username, password);
    }
    
    private static void doStartSession(String endpointAddress, String username, String password)
        throws AuthenticationFault
    {
        try
        {
        	AuthenticationServiceSoapBindingStub authenticationService = endpointAddress == null ?
        			WebServiceFactory.getAuthenticationService() :
    ...
    public static void endSession()
    {
        ...
        if (authenticationDetails != null)
        {
            try
            {
            	String endpointAddress = authenticationDetails.getEndpointAddress();
            	AuthenticationServiceSoapBindingStub authenticationService = endpointAddress == null ?
            			WebServiceFactory.getAuthenticationService() :
            				WebServiceFactory.getAuthenticationService(endpointAddress);
